...
function compileToString(str, config) {
    ...
    var res = "var tR='',__l,__lP" +
        ...
        (config.includeFile
            ? 'if(__l)tR=' +
                (config.async ? 'await ' : '') +
                "includeFile(__l,Object.assign(".concat(config.varName, ",{body:tR},__lP))\n")
            : config.include
                ? 'if(__l)tR=' +
                    (config.async ? 'await ' : '') +
                    "include(__l,Object.assign(".concat(config.varName, ",{body:tR},__lP))\n")
                : '') +
...
export { compile, compileToString, config, configure, config as defaultConfig, getConfig, parse, render, renderAsync, templates };
//# sourceMappingURL=eta.es.dev.js.map
